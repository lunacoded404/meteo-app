...
//   const popupMaxW = isMobile ? Math.min(420, Math.floor(window.innerWidth * 0.92)) : 360;
//   const popupMinW = isMobile ? Math.min(320, Math.floor(window.innerWidth * 0.80)) : 260;

//   return (
//     // ✅ Map wrapper: bạn nên đặt parent có height responsive (vd: h-[70vh] min-h-[420px])
...
//       {/* ✅ SearchBar overlay: mobile full width + bám safe-area */}
//       <div
//         className="
...
//       {/* ✅ FABs + checkbox: mobile dồn xuống dưới để đỡ che map */}
//       <div
//         className="
//           absolute z-[1000] pointer-events-auto
//           right-3 top-[72px]
...
//         {/* ✅ mobile: icon-only nhỏ hơn, desktop: giữ như cũ */}
