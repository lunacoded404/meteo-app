...
const windDescriptionVN = (kmh: number) => {
  // Ngưỡng tham khảo, bạn có thể chỉnh cho hợp thực tế VN
...
export default function WindPopup({ data, loading, error }: WindPopupProps) {
  ...
  const desc =
    spd == null ? "Chưa có dữ liệu gió hiện tại." : windDescriptionVN(spd);
